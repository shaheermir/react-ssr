...
app.use("/api", (0, _expressHttpProxy2.default)("http://www.react-ssr-api.herokuapp.com", {
  proxyReqOptDecorators: function proxyReqOptDecorators(opts) {
...
app.listen(3000, function () {
  return console.log("Server is running on localhost:3000");
});
